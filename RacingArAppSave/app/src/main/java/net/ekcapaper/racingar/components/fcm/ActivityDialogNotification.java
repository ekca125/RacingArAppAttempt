package net.ekcapaper.racingar.components.fcm;
...
import net.ekcapaper.racingar.components.activity.MainMenu;
import net.ekcapaper.racingar.components.model.NotifType;
import net.ekcapaper.racingar.components.room.AppDatabase;
import net.ekcapaper.racingar.components.room.DAO;
import net.ekcapaper.racingar.components.room.table.NotificationEntity;
...
public class ActivityDialogNotification extends AppCompatActivity {
    ...
    private void initComponent() {
        ...
        if (notification.type == null || notification.type.equals("")) {
            ((TextView) findViewById(R.id.type)).setVisibility(View.GONE);
        } else {
            ((TextView) findViewById(R.id.type)).setVisibility(notification.type.equalsIgnoreCase("NORMAL") ? View.INVISIBLE : View.VISIBLE);
        }
