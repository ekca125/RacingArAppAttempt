...
using Model = RacingArApp.Models.Story;

namespace RacingArApp.ViewModels
{
    /// <summary>
    ...
    [DataContract]
    public class ArticleCardPageViewModel : BaseViewModel
    {
        #region fields

        private static ArticleCardPageViewModel articleCardViewModel;
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="ArticleCardPageViewModel" />
        /// </summary>
        public ArticleCardPageViewModel()
        {
        }
        ...
        /// </summary>
        public static ArticleCardPageViewModel BindingContext =>
            articleCardViewModel = PopulateData<ArticleCardPageViewModel>("catalog.json");
        ...
        {
            var file = "RacingArApp.Data." + fileName;
