package com.ekcapaper.racingar.components.data;
...
import com.ekcapaper.racingar.components.model.CardViewImg;
import com.ekcapaper.racingar.components.model.Image;
import com.ekcapaper.racingar.components.model.Inbox;
import com.ekcapaper.racingar.components.model.MusicAlbum;
import com.ekcapaper.racingar.components.model.MusicSong;
import com.ekcapaper.racingar.components.model.News;
import com.ekcapaper.racingar.components.model.People;
import com.ekcapaper.racingar.components.model.ShopCategory;
import com.ekcapaper.racingar.components.model.ShopProduct;
import com.ekcapaper.racingar.components.model.Social;
import com.ekcapaper.racingar.components.utils.MaterialColor;
...
public class DataGenerator {
    ...
    /**
     * Generate dummy data Photo Info
     *
     * @param ctx   android context
     * @param count total result data
     * @return list of object
     */
    public static List<Image> getPhotoInfo(Context ctx) {
        List<Image> items = new ArrayList<>();
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.photo_info_icon);
        String name[] = ctx.getResources().getStringArray(R.array.photo_info_name);
        for (int i = 0; i < drw_arr.length(); i++) {
            Image obj = new Image();
            obj.image = drw_arr.getResourceId(i, -1);
            obj.name = name[i];
