package com.ekcapaper.racingar.components.adapter;
...
public class AdapterGridMusicCardAlbums extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterGridMusicCardAlbums(Context context, List<MusicAlbum> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_music_card_album, parent, false);
