...
public class MenuDrawerSliderSimple extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_drawer_slider_simple);
    ...
    private void initToolbar() {
        ...
        actionBar.setTitle("Slider Simple");
