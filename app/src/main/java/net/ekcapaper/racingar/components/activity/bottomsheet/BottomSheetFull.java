package net.ekcapaper.racingar.components.activity.bottomsheet;
...
import net.ekcapaper.racingar.components.adapter.AdapterPeopleLeft;
import net.ekcapaper.racingar.components.data.DataGenerator;
import net.ekcapaper.racingar.components.fragment.FragmentBottomSheetDialogFull;
