package net.ekcapaper.racingar.components.activity.bottomnavigation;
...
import net.ekcapaper.racingar.components.adapter.AdapterGridShopCategory;
import net.ekcapaper.racingar.components.data.DataGenerator;
import net.ekcapaper.racingar.components.helper.BottomNavigationViewHelper;
