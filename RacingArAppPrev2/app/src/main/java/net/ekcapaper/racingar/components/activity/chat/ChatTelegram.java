package net.ekcapaper.racingar.components.activity.chat;
...
import net.ekcapaper.racingar.components.adapter.AdapterChatTelegram;
import net.ekcapaper.racingar.components.model.Message;
