...
import net.ekcapaper.racingar.components.model.CardViewImg;
import net.ekcapaper.racingar.components.model.Image;
import net.ekcapaper.racingar.components.model.Inbox;
import net.ekcapaper.racingar.components.model.MusicAlbum;
import net.ekcapaper.racingar.components.model.MusicSong;
import net.ekcapaper.racingar.components.model.News;
import net.ekcapaper.racingar.components.model.People;
import net.ekcapaper.racingar.components.model.ShopCategory;
import net.ekcapaper.racingar.components.model.ShopProduct;
import net.ekcapaper.racingar.components.model.Social;
import net.ekcapaper.racingar.components.utils.MaterialColor;
